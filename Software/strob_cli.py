...
parser.add_argument('--light', '-l', help='Light mode 1/0', default=1)
parser.add_argument('--brightness', '-br', help='Light brightness 0 - 100%', default=100)
parser.add_argument('--frequency', '-f', help='Frequency 1Hz - 1000Hz', default=100)
parser.add_argument('--period', '-pd', help='Period of flash 16μs - 65.000μs', default=45)
